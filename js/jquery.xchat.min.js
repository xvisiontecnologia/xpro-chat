! function(e) {
    "use strict";
    e.XChat = function(t) {
        t.css = t.css ? t.css + "/wp-content/themes/xvision/xchat.css" : "xchat.css", e("head").append('<link rel="stylesheet" href="' + t.css + '" type="text/css" />');
        var a = "Xchat-" + (new Date).getTime();
        e("body").append('<div id="' + a + '"></div>');
        var n = e("#" + a);
        t.ssl ? (t.proto = "wss", t.apihttp = "https://" + t.host) : (t.proto = "ws", t.apihttp = "http://" + t.host), t.port = t.port ? ":" + t.port : "", t.apiSocket = t.proto + "://" + t.host + t.port + t.path, e.cookie("xChat-tk") && (t.tk = e.cookie("xChat-tk")), n.addClass("XChat");
        ...
        var i = function() {
                function a() {
                    e("<button>", {
                        id: "xchat-btn-status",
                        type: "button"
                    }).text("Fale com um consultor").appendTo(n), n.find("#xchat-btn-status").click(function() {
                        e(this).hasClass("disabled") || (e(this).addClass("disabled"), e(this).hasClass("online") && (n.hasClass("with-departments") || s.emit({
                            type: "get-departments",
                            token: t.tk,
                            api: t.host
                        })))
                    })
                }
                return a.prototype.makeWindow = function(a, i) {
                    function o(e) {
                    ...
                    function r(t) {
                        ...
                        e.inArray(t.which, a) >= 0 || t.preventDefault()
                    }
                    ...
                    String.prototype.URLToAnchors = function() {
                        ...
                        return this.replace(p, "<a href=$1 target=_blank>$1</a>")
                            .replace(p2, '$1<a href=http://$2 target=_blank>$2</a>')
                            .replace(p3, '<a href=mailto:$1 target=_blank>$1</a>');
                    }

                    function l() {
                        if (n.hasClass("talking")) {
                            var a;
                            a = n.find("#xchat-user-message").val().URLToAnchors() , a && (n.find("#xchat-user-message").val("").focus(), s.emit({
                                type: "new-message",
                                from: "client",
                                chatId: e.cookie("xChat-chatId"),
                                text: a,
                                adminId: n.find(".chat-window-header").find(".name").attr("data-id"),
                                token: t.tk,
                                api: t.host
                            }))
                        } else {
                            var i = {
                                    name: n.find("#xchat-user-name"),
                                    email: n.find("#xchat-user-email"),
                                    telephone: n.find("#xchat-user-telephone"),
                                    department: n.find("#xchat-user-departments")
                                },
                                d = !1;
                            if (i.name.val() ? i.name.removeClass("error") : (i.name.addClass("error"), d = !0), i.email.val() ? o(i.email) === !1 && (d = !0) : (i.email.addClass("error"), d = !0), i.telephone.val() ? c(i.telephone) === !1 && (d = !0) : (i.telephone.addClass("error"), d = !0), i.department.length && (i.department.val() || (i.department.addClass("error"), d = !0)), d) {
                                if (!n.find(".form-error").length) {
                                    var r;
                                    n.find(".chat-window-content").append(e("<div>", {
                                        "class": "form-error"
                                    }).text("Por favor, preencha os campos em destaque corretamente!")), r = e(".chat-window-content").height() + 21, n.find(".chat-window-content").css("height", r + "px"), r = e(".chat-window").height() + 169, n.find(".chat-window").css("height", r + "px")
                                }
                            } else n.find(".chat-window").removeAttr("style"), n.find(".chat-window-content").removeAttr("style"), p.loader(), n.find("#chat-send").attr("disabled", !0), t.tk = i.department.val(), s.emit({
                                type: "new-chat",
                                name: i.name.val(),
                                email: i.email.val(),
                                telephone: i.telephone.val(),
                                department: i.department.val(),
                                campaign: t.campaign,
                                product: t.product,
                                token: t.tk,
                                api: t.host
                    ...
                    if (t.departments.length > 0 && (a.departments = t.departments), n.find("#xchat-btn-status").css("height", 0), e("<div>", {
                            ...
                            id: "chat-send",
                            type: "button"
                        }).text("enviar"))).addClass("min").prependTo(n), n.find("#xchat-window").fadeIn(1e3, function() {
                            e(this).removeClass("min")
                        }), i) n.addClass("talking");
                    else if (n.find(".chat-window-content").append(e("<input/>", {
                            id: "xchat-user-name",
                            "class": "input-text",
                            type: "text",
                            placeholder: "Nome"
                    ...
                    }), n.find("#xchat-user-telephone").keypress(function(e) {
                        13 !== e.keyCode && h(this, e)
                    }), n.find("#chat-send").click(function() {
                        l()
                    }), n.on("keypress", "#xchat-user-message", function(e) {
                        13 === e.which && e.shiftKey === !1 && l()
                    })
                }, a.prototype.makeChat = function(t) {
                    n.find(".chat-window-content").html('<div class="message modelo"></div>'), n.find(".chat-window-header").prepend(e("<img/>", {
                        "class": "image",
                        src: t.admin.image
                    })), n.find(".chat-window-header").find(".name").text(t.admin.name).attr("data-id", t.admin.id), n.find(".chat-window-footer").prepend(e("<input/>", {
                        id: "xchat-user-message",
                        "class": "input-text",
                        type: "text",
                        placeholder: "Escreva aqui sua mensagem..."
                    })), n.find("#xchat-user-message").focus()
                }, a.prototype.makeNewMessage = function(e, t) {
                    var a, i;
                    a = n, i = a.find(".message.modelo").clone(), i.html(e.text).removeClass("modelo").addClass(e.from), a.find(".chat-window-content").append(i), e.admin && (a.find(".chat-window-header").find(".image").attr("src", e.admin.image), a.find(".chat-window-header").find(".name").text(e.admin.name).attr("data-id", e.admin.id)), t ? a.find(".chat-window-content").animate({
                        scrollTop: a.find(".chat-window-content")[0].scrollHeight
                    }, 0) : a.find(".chat-window-content").animate({
                        scrollTop: a.find(".chat-window-content")[0].scrollHeight
                    }, 800)
                }, a.prototype.closeChat = function() {
                    n.find(".chat-window").remove(), n.removeClass("talking").removeClass("with-departments"), n.find("#xchat-btn-status").removeAttr("style").removeClass("disabled")
                }, a.prototype.status = function(t) {
                    //1 === t.status && e("#xchat-btn-status").text("Fale com um consultor").addClass("online")
                    e("#xchat-btn-status").text("Fale com um consultor").addClass("online")
                }, a.prototype.loader = function() {
                    n.find(".chat-window-content").html(e("<div>", {
            ...
            s = function(a) {
                function i() {
                    var i = new a;
                    this.token = t.tk, this.socket = new WebSocket(t.apiSocket), this.socket.onerror = function(e) {
                        ...
                        try {
                            ...
                            console.log("Invalid response:", a), a = {}
                        }
                        switch (a.type) {
                            case "status":
                                i.status(a);
                                break;
                            case "all-messages":
                                i.makeWindow(a, !0), i.makeChat(a), a.messages.forEach(function(e) {
                                    i.makeNewMessage(e, "all")
                                });
                                break;
                            case "get-departments":
                                n.addClass("with-departments"), i.makeWindow(a);
                                break;
                            case "new-message":
                                i.makeNewMessage(a), "admin" === a.from && (e("#XChat-audio-notification").remove(), e("<audio>", {
                                    id: "XChat-audio-notification"
                                }).html('<source src="' + t.apihttp + '/midias/audio/notificacoes/client.mp3">').appendTo("body"), e("#XChat-audio-notification")[0].play());
                                break;
                            case "new-chat":
                                a.error ? console.log("Erro na construção do Chat") : (n.addClass("talking"), i.makeChat(a), e.cookie("xChat-tk", t.tk), e.cookie("xChat-chatId", a.chatId), n.find("#chat-send").removeAttr("disabled"));
                                break;
                            case "close-chat":
                                a.closed && (e.removeCookie("xChat-tk"), e.removeCookie("xChat-chatId"), i.closeChat())
                        }
                    }
                }
...
function(e) {
    ...
    var o = /\+/g,
        c = e.cookie = function(i, o, d) {
            if (arguments.length > 1 && !e.isFunction(o)) {
                if (d = e.extend({}, c.defaults, d), "number" == typeof d.expires) {
                    var r = d.expires,
                        h = d.expires = new Date;
                    h.setMilliseconds(h.getMilliseconds() + 864e5 * r)
                }
                return document.cookie = [t(i), "=", n(o), d.expires ? "; expires=" + d.expires.toUTCString() : "", d.path ? "; path=" + d.path : "", d.domain ? "; domain=" + d.domain : "", d.secure ? "; secure" : ""].join("")
            }
            for (var l = i ? void 0 : {}, p = document.cookie ? document.cookie.split("; ") : [], m = 0, A = p.length; A > m; m++) {
                var u = p[m].split("="),
                    w = a(u.shift()),
                    g = u.join("=");
                if (i === w) {
                ...
                i || void 0 === (g = s(g)) || (l[w] = g)
            }
            return l
        };
    c.defaults = {}, e.removeCookie = function(t, a) {
